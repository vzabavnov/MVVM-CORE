...
namespace Zabavnov.Windows.Forms.MVVM
{
    ...
    public static class DateTimePickerBinders
    {
        ...
        public static readonly IPropertyBinder<DateTimePicker, DateTime?> MinDateBinder =
            new PropertyBinder<DateTimePicker, DateTime, DateTime?>(z => z.MinDate,
        ...
        public static readonly IPropertyBinder<DateTimePicker, DateTime?> MaxDateBinder =
            new PropertyBinder<DateTimePicker, DateTime, DateTime?>(z => z.MaxDate,
                new NullableConverter<DateTime>(DateTimePicker.MaxDateTime));

        /// <summary>
        ///     binder for <see cref="DateTimePicker.Value" />
        /// </summary>
        public static readonly IPropertyBinder<DateTimePicker, DateTime?> DateBinder =
            new PropertyBinder<DateTimePicker, DateTime, DateTime?>(z => z.Value,
                (ctrl, action) => ctrl.ValueChanged += (sender, args) => action(),
                new NullableConverter<DateTime>(DateTimePicker.MinDateTime));

        /// <summary>
        ///     binder for <see cref="DateTimePicker.CustomFormat" />
        /// </summary>
        public static readonly PropertyBinder<DateTimePicker, string> FormatBinder =
            new PropertyBinder<DateTimePicker, string>(z => z.CustomFormat,
